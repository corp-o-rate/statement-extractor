...
Each statement includes confidence scores and extraction method (v0.3.0+):
...
v0.3.0 features: spaCy-first predicate extraction, multi-candidate generation, combined scoring (semantic + grammatical), best triple selection per source.
