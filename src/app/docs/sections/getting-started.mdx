...
**v0.5.0 features**: 6-stage pipeline with entity qualification, canonicalization, labeling, and taxonomy classification. GLiNER2 entity recognition, entity-based scoring, plugin architecture.

**v0.6.0 features**: Company embedding database with ~100K+ SEC filers, ~3M GLEIF records, ~5M UK companies for fast entity qualification.
