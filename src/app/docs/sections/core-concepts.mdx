...
- **GLEIFQualifier**: Looks up Legal Entity Identifier (LEI) for organizations
- **CompaniesHouseQualifier**: Adds UK company registration numbers
- **SECEdgarQualifier**: Adds SEC CIK and ticker symbols for US public companies
