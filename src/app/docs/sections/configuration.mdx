...
Configuration for the 6-stage extraction pipeline. Controls which stages run, which plugins are enabled, and stage-specific options.
...
# Use presets
config = PipelineConfig.default()   # All 6 stages
